...
import { Loader2, RefreshCw, GripVertical, Receipt } from 'lucide-react'
  ...
  return (
    <div className="mx-auto w-full max-w-[1600px] space-y-4 px-4 py-4 sm:space-y-5 sm:py-6 lg:px-6">
      <PageHeader
        ...
        subtitle="Drag orders across the fulfilment pipeline. Status changes are logged to activity."
        actions={
                ...
                <div className="flex-1 space-y-2 p-2">
                  {colOrders.map((o) => (
                    <div
                      ...
                      onClick={() => navigate(`/sales/orders?order=${o.id}`)}
                    >
